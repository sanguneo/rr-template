...
function Counter() {
  ...
  return (
    <div className="flex-center flex-col gap-4">
      <h1 className="text-gradient">Count: {count}</h1>
    ...
    <main className="flex items-center justify-center pt-16 pb-4">
      <div className="flex-1 flex flex-col items-center gap-16 min-h-0">
        ...
        <div className="flex gap-4">
          <NavLink to="/counter" className="rounded-full bg-blue-600 px-6 py-2 text-white hover:bg-blue-700 transition-colors">
            카운터 예제 보러가기
          </NavLink>
        </div>
